                ...
                <div class="row">
                  <div class="col-12">
                    <div class="table table-responsive table-striped table-condensed table-hover collapse" id="collapse-select-embutido">
                      <?php includeWithVariables(PATH_ROOT . 'inc/table_rule.php', array('chosen' => '<small class="table-typografy-xs">select</small>', 'select' => '<small class="table-typografy-xs">select</small>', 'select2' => '<small class="table-typografy-xs">select</small>')); ?>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="table table-responsive table-striped table-condensed table-hover collapse" id="collapse-select-externo">
                      <?php includeWithVariables(PATH_ROOT . 'inc/table_custom.php', array('chosen' => '<small class="table-typografy-xs">select</small>', 'select' => '<small class="table-typografy-xs">select</small>', 'select2' => '<small class="table-typografy-xs">select</small>')); ?>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="table table-responsive table-striped table-condensed table-hover collapse" id="collapse-select-externo-template">
                      <?php includeWithVariables(PATH_ROOT . 'inc/table_custom_template.php', array('chosen' => '<small class="table-typografy-xs">select</small>', 'select' => '<small class="table-typografy-xs">select</small>', 'select2' => '<small class="table-typografy-xs">select</small>')); ?>
                    </div>
                  </div>
                </div>
