                      <table class="table table-bordered table-sm">
                         ...
                         <tbody>
                            <tr>
                               ...
                               <td class="text-center" width="20%"><small class="table-typografy-xs"><i>state</i></small></td>
                               <td class="text-center" width="20%"><small class="table-typografy-xs"><i>city</i></small></td>
                               <td class="text-center" width="20%"><small class="table-typografy-xs"><i>district</i></small></td>
                            </tr>
                            <tr>
                               ...
                               <td class="text-center"><small class="table-typografy-xs"><i>estados_rule</i></small></td>
                            ...
                            <tr>
                               ...
                               <td class="text-center"><small class="table-typografy-xs">.cidades_rule</small></td>
                               <td class="text-center"><small class="table-typografy-xs">.bairros_rule</small></td>
                               <td class="text-center"><i class="fa fa-minus" aria-hidden="true"></i></td>
                            </tr>
                            <tr>
                               ...
                               <td class="text-center"><small class="table-typografy-xs">string</small></td>
                               <td class="text-center"><i class="fa fa-minus" aria-hidden="true"></i></td>
                               <td class="text-center"><small class="table-typografy-xs">#estados_rule</small></td>
                               <td class="text-center"><small class="table-typografy-xs">#cidades_rule</small></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                               ...
                               <td class="text-center"><small class="table-typografy-xs">rtl</small></td>
                               <td class="text-center"><small class="table-typografy-xs">rtl</small></td>
                               <td class="text-center"><small class="table-typografy-xs">rtl</small></td>
                            </tr>
                            <tr>
