<?php include_once(__DIR__ . '/../include.php');?>
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <a class="pull-right" data-toggle="collapse" id="chosen-embutido"  href="#collapse-chosen-embutido" aria-expanded="false" aria-controls="collapse-chosen-embutido">
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="table table-responsive table-striped table-condensed table-hover collapse" id="collapse-chosen-embutido">
                      <?php includeWithVariables(PATH_ROOT . 'inc/table_rule.php', array('chosen' => '<small class="table-typografy-xs">chosen</small>', 'select' => '<small class="table-typografy-xs">chosen</small>', 'select2' => '<small class="table-typografy-xs">chosen</small>')); ?>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 has-default">
                    ...
                    <small id="estados_rule_chosenHelpBlock" class="form-control-feedback">Regra Encadeável dos Estados com Filtro de Cidades</small>
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 has-default">
                    ...
                    <small id="cidades_rule_chosenHelpBlock" class="form-control-feedback">Regra Encadeável das Cidades com Filtro de Bairros</small>
                ...
                <div class="row">
                  <div class="col-6"><h5>Legenda</h5></div>
                  <div class="col-6">
                    <a class="pull-right" data-toggle="collapse" id="chosen-externo" href="#collapse-chosen-externo" aria-expanded="false" aria-controls="collapse-chosen-externo">
                      Ver/Esconder <i class="fa fa-chevron-down" aria-hidden="true"></i>
                    </a>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="table table-responsive table-striped table-condensed table-hover collapse" id="collapse-chosen-externo">
                      <?php includeWithVariables(PATH_ROOT . 'inc/table_custom.php', array('chosen' => '<small class="table-typografy-xs">chosen</small>', 'select' => '<small class="table-typografy-xs">chosen</small>', 'select2' => '<small class="table-typografy-xs">chosen</small>')); ?>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-6"><h5>Legenda</h5></div>
                  <div class="col-6">
                    <a class="pull-right" data-toggle="collapse" id="chosen-externo-template" href="#collapse-chosen-externo-template" aria-expanded="false" aria-controls="collapse-chosen-externo-template">
                      Ver/Esconder <i class="fa fa-chevron-down" aria-hidden="true"></i>
                    </a>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="table table-responsive table-striped table-condensed table-hover collapse" id="collapse-chosen-externo-template">
                      <?php includeWithVariables(PATH_ROOT . 'inc/table_custom_template.php', array('chosen' => '<small class="table-typografy-xs">chosen</small>', 'select' => '<small class="table-typografy-xs">chosen</small>', 'select2' => '<small class="table-typografy-xs">chosen</small>')); ?>
                    </div>
                  </div>
                </div>
