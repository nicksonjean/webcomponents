                <div class="row">
                  ...
                  <div class="col-6">
                    <a class="pull-right" data-toggle="collapse" href="#collapse-<?php echo $type;?>-embutido" aria-expanded="false" aria-controls="collapse-<?php echo $type;?>-embutido">
                ...
                <div class="row">
                  <div class="col-6"><h5>Legenda</h5></div>
                  <div class="col-6">
                    <a class="pull-right" data-toggle="collapse" href="#collapse-<?php echo $type;?>-externo" aria-expanded="false" aria-controls="collapse-<?php echo $type;?>-externo">
                      <i class="fa fa-chevron-down" aria-hidden="true"></i>
                    </a>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-6"><h5>Legenda</h5></div>
                  <div class="col-6">
                    <a class="pull-right" data-toggle="collapse" href="#collapse-<?php echo $type;?>-externo-template" aria-expanded="false" aria-controls="collapse-<?php echo $type;?>-externo-template">
                      <i class="fa fa-chevron-down" aria-hidden="true"></i>
                    </a>
                  </div>
                </div>
