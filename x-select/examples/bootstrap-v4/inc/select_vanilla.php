<?php include_once(__DIR__ . '/../include.php');?>
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="table table-responsive table-striped table-condensed table-hover collapse" id="collapse-vanilla-embutido">
                      <?php includeWithVariables(PATH_ROOT . 'inc/table_rule.php', array('chosen' => '<i class="fa fa-minus" aria-hidden="true"></i>', 'select' => '<i class="fa fa-minus" aria-hidden="true"></i>', 'select2' => '<i class="fa fa-minus" aria-hidden="true"></i>')); ?>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 has-default">
                    ...
                    <small id="estados_ruleHelpBlock" class="form-control-feedback">Regra Encadeável dos Estados com Filtro de Cidades</small>
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 has-default">
                    ...
                    <small id="cidades_ruleHelpBlock" class="form-control-feedback">Regra Encadeável das Cidades com Filtro de Bairros</small>
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="table table-responsive table-striped table-condensed table-hover collapse" id="collapse-vanilla-externo">
                      <?php includeWithVariables(PATH_ROOT . 'inc/table_custom.php', array('chosen' => '<i class="fa fa-minus" aria-hidden="true"></i>', 'select' => '<i class="fa fa-minus" aria-hidden="true"></i>', 'select2' => '<i class="fa fa-minus" aria-hidden="true"></i>')); ?>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 has-default">
                    ...
                    <select class="custom-select form-control"              is="x-select" x-source="<?php echo SOURCE_ROOT;?>/src/data/Estados_Compacted.json" x-connect=".cidades_pair" x-value="//ID"                   x-text="//Nome"                                               x-default="Escolha um Estado"  x-filter="ID" x-selected="23"                      name="estados_pair" id="estados_pair" aria-describedby="estados_pairHelpBlock"></select>
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="table table-responsive table-striped table-condensed table-hover collapse" id="collapse-vanilla-externo-template">
                      <?php includeWithVariables(PATH_ROOT . 'inc/table_custom_template.php', array('chosen' => '<i class="fa fa-minus" aria-hidden="true"></i>', 'select' => '<i class="fa fa-minus" aria-hidden="true"></i>', 'select2' => '<i class="fa fa-minus" aria-hidden="true"></i>')); ?>
                    </div>
                  </div>
                </div>
